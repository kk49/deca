...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bt_archive_open = QtWidgets.QPushButton(self.layoutWidget)
        self.bt_archive_open.setEnabled(False)
        self.bt_archive_open.setObjectName("bt_archive_open")
        self.horizontalLayout_6.addWidget(self.bt_archive_open)
        self.edt_archive_name = QtWidgets.QLineEdit(self.layoutWidget)
        self.edt_archive_name.setObjectName("edt_archive_name")
        self.horizontalLayout_6.addWidget(self.edt_archive_name)
